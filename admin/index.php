...
<body>
    ...
    <!--- designing admin login page--->
<div class="container-fluid">
   <div class="col-md-12">
      <div class="row">
         <div class="col-md-2" style="margin-left: -30px;">
           
           <!---connecting the sidenav.php file--->
           <?php 
            include("sidenav.php");
           ?>
         ...
         <!---designing admin page inside admin portal--->
         <h4 class="my-2">Admin Dashboard</h4>

          <div class="col-md-12 my-1">
            <div class="row">
               <!---mx-2 is splitting the boxes by a box of size 2 between them--->
                  ...
                  <div class="col-md-12">
                     <div class="row">
                        <div class="col-md-9">
                           ...
                           <h5 class="col-md-2 text-white" style="font-size: 30px;"><?php echo $num; ?></h5>
                           <h5 class="text-white">Total</h5>
                           <h5 class="text-white">Admin</h5>
                     </div>
                        <div class="col-md-3">
                           <!---the code below is for adding admin icon click fontawesome.com clickicons right click and copy the link below--->
                   ...
                   <div class="col-md-12">
                     <div class="row">
                        <div class="col-md-9">
                          ...
                          ?>
                           <h5 class="col-md-2 text-white" style="font-size: 30px;"><?php echo $num2; ?></h5>
                           <h5 class="text-white">Total</h5>
                   ...
                   <div class="col-md-12">
                     <div class="row">
                        <div class="col-md-9">
                          ...
                          ?>
                           <h5 class="col-md-2 text-white" style="font-size: 30px;"><?php echo $pp; ?></h5>
                           <h5 class="text-white">Total</h5>
                   ...
                   <div class="col-md-12">
                     <div class="row">
                        <div class="col-md-9">
                          ...
                          ?>
                           <h5 class="col-md-2 text-white" style="font-size: 30px;"><?php echo $rep; ?></h5>
                           <h5 class="text-white">Total</h5>
                   ...
                   <div class="col-md-12">
                     <div class="row">
                        <div class="col-md-9">
                          ...
                          ?>
                           <h5 class="col-md-2 text-white" style="font-size: 30px;"><?php echo "$$inc"; ?></h5>
                           <h5 class="text-white">Total</h5>
                   ...
                   <div class="col-md-12">
                     <div class="row">
                        <div class="col-md-9">
                          ...
                          ?>
                           <h5 class="col-md-2 text-white" style="font-size: 30px;"><?php echo $num1; ?></h5>
                           <h5 class="text-white">Total</h5>
