...
<body>
     <!--Sidenav-->
            <div class="list-group bg-info" style="height: 90vh;">
               ...
               Profile</a>
               <a href="appointment.php" class="list-group-item list-group-item-action bg-info text-center text-white">
               Book Appointment</a>
               <a href="invoice.php" class="list-group-item list-group-item-action bg-info text-center text-white">
               Invoice</a>
            </div>
     <!--ends-->
</body>
