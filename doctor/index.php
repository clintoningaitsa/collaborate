									...
									<div class="col-md-3 my-2 bg-warning mx-2" style="height:150px;">
										...
										<div class="col-md-12">
										 <div class="row">
										 	...
										 	<div class="col-md-4">
										 		<a href="patient.php"><i class="fa fa-user-circle fa-3x my-4"style="color: white;"></i></a>
										 	</div>
										 </div>
										</div>
									</div>
										...
										<div class="col-md-12">
										 <div class="row">
										 	<div class="col-md-8">
										 		...
										 		?>
										 		<h5 class="text-white my-2"style="font-size: 30px;"><?php echo
										 		$appoint; ?></h5>
										 		<h5 class="text-white">Total</h5>
										 	...
										 	<div class="col-md-4">
										 		<a href="appointment.php"><i class="fa fa-user-circle fa-3x my-4"style="color: white;"></i></a>
										 	</div>
										 </div>
										</div>
									</div>
